...
bool Mapper_066::gpuMapRead(uint16_t addr, uint32_t &mapped_addr){
	if (addr < 0x2000){
...
bool Mapper_066::gpuMapWrite(uint16_t addr, uint32_t &mapped_addr){ return false; }

void Mapper_066::reset(){ nCHRBankSelect = 0; nPRGBankSelect = 0; }
